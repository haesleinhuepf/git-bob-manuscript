...
We present git-bob, an open-source AI-assistant integrated with GitHub/GitLab that facilitates iterative collaboration and transparency in AI-assisted data analysis and code generation within discussion threads.
