...
\begin{abstract}
The integration of Large Language Models (LLMs) in scientific workflows presents challenges in transparency and knowledge exchange. These challenges arise from the often undocumented use of LLMs, affecting the reproducibility and accountability of AI-assisted data analysis. This manuscript examines these issues and introduces git-bob, an open-source AI-assistant that addresses these challenges by facilitating transparent and documented interactions on the GitHub platform. By enabling multi-disciplinary collaborations and maintaining a clear record of AI-assisted solutions, git-bob contributes to the responsible use of AI, fostering improved knowledge exchange among life scientists, data analysts, and AI practitioners.
\end{abstract}
